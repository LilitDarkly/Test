...
namespace Test
{
    public partial class Form1 : Form
    {
        ...
        void состаяниепереключения(object sender, EventArgs e)
        {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            radioButton1.CheckedChanged += new EventHandler(состаяниепереключения);
            radioButton2.CheckedChanged += new EventHandler(состаяниепереключения);
            radioButton3.CheckedChanged += new EventHandler(состаяниепереключения);
            start();
